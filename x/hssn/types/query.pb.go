...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_be7ba175d79b71f2, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_be7ba175d79b71f2, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "hssn.hssn.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "hssn.hssn.QueryParamsResponse")
}

func init() { proto.RegisterFile("hssn/hssn/query.proto", fileDescriptor_be7ba175d79b71f2) }

var fileDescriptor_be7ba175d79b71f2 = []byte{
	// 289 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xcd, 0x28, 0x2e, 0xce,
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xbb, 0x74, 0x96, 0x0c, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hssn.hssn.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hssn.hssn.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "hssn/hssn/query.proto",
}
