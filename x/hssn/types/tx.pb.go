...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_c89c80fade573f7b, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c89c80fade573f7b, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "hssn.hssn.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "hssn.hssn.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("hssn/hssn/tx.proto", fileDescriptor_c89c80fade573f7b) }

var fileDescriptor_c89c80fade573f7b = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xca, 0x28, 0x2e, 0xce,
	...
	0x96, 0xfd, 0xe3, 0xc4, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hssn.hssn.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hssn.hssn.Msg/UpdateParams",
	}
